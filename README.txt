...
1. Use menu entry Tools / Higher-Order Structure / Multiscale Models, select multimer type "3x3x3 crystal unit cells" and press the "Make models" button.
...
This is a modified version of a protocol originally from Tom Goddard.
